    ...
    <div
      ...
      <div className="absolute flex items-center justify-center top-0 left-0 w-full h-full rounded-lg bg-gradient-to-r from-gray-900">
        <div className="text-white text-center space-y-3 ">
          ...
          <Link className="bg-yellow-500 p-2 md:text-lg text-sm rounded-md hover:scale-[103%] hover:bg-yellow-600 active:bg-yellow-500 cursor-pointer duration-200 text-black font-semibold inline-block  ">
            See all foods
          </Link>
        </div>
      </div>
